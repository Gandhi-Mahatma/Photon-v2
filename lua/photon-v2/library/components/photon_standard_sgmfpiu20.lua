...
COMPONENT.StateMap = "[DIM] TailL TailR [W] HeadL HeadR HighL HighR [W/1/2] RevL [W/2/1] RevR [R] 21 [A] SigFL SigFR [A/1/2] SigRL [A/2/1] SigRR [W/1/2] 22 24 [W/2/1] 23 25 [ON] 26"
